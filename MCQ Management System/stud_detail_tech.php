...
function showdata(){
    ...
    if($run==TRUE){
        ...
        <tr style="background:transparent; box-shadow: 0 -3px 8px inset grey;" height="50" class="col-md-12" height="40" class="col-md-12" >
            ...
            <td style="border-right: 2px solid #154360;" align="center" class="col-md-1"><button class="btn btn-primary btn-sm font"><a href="stud_detail_tech.php?sid=<?php echo $data['prn']; ?>&q=1" class="text-white">View</a></button> </td>
...
<body>
    ...
    <div style="background:transparent;" class="rounded">
      ...
      <?php if(@$_GET['q']==0) { 
            showdata(); 
        echo ' <br> <p align="right"><a href="teacher.php" class="btn btn-md btn-primary" style="cursor: pointer;"> Back </a></p><br>';
        }
        ?>
        ...
        <?php if(@$_GET['q']==1) { 
            $sid=$_GET['sid'];
            showresult($sid); 
        echo ' <br> <p align="right"><a href="stud_detail_tech.php?q=0" class="btn btn-md btn-primary" style="cursor: pointer;"> Back </a></p><br>';
        }
        ?>
